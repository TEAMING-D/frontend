...
class ModifyMeetingPage extends StatefulWidget {
  final Map<String, dynamic> meeting;

  const ModifyMeetingPage({required this.meeting});

  @override
  _ModifyMeetingPageState createState() => _ModifyMeetingPageState();
}

class _ModifyMeetingPageState extends State<ModifyMeetingPage> {
  ...
  void initState() {
    ...
    startDate = widget.meeting['startDate'];
    endDate = widget.meeting['endDate'];
    selectedMembers = List<String>.from(widget.meeting['members']);
  }
                      ...
                      CupertinoButton(
                        ...
                        onPressed: () {
                          setState(() {
                            ...
                            FocusScope.of(context).unfocus(); // 키보드 포커스 해제 추가
                          });
                          Navigator.pop(context);
                        },
                      ),
